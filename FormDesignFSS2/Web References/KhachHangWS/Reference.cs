...
namespace FormDesignFSS2.KhachHangWS {
    ...
    public partial class KhachHangBUS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetKHWithIDOperationCompleted;
        ...
        /// <remarks/>
        public event GetKHWithIDCompletedEventHandler GetKHWithIDCompleted;
        ...
        public int KTThongTinThemKH(string soTKLK, System.DateTime ngayMoTK, string hoTen, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string diaChi, string email, string SDT, string ghiChu) {
        ...
        /// <remarks/>
        public void KTThongTinThemKHAsync(string soTKLK, System.DateTime ngayMoTK, string hoTen, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string diaChi, string email, string SDT, string ghiChu) {
            this.KTThongTinThemKHAsync(soTKLK, ngayMoTK, hoTen, ngaySinh, ngheNghiep, soCMND, diaChi, email, SDT, ghiChu, null);
        }
        
        /// <remarks/>
        public void KTThongTinThemKHAsync(string soTKLK, System.DateTime ngayMoTK, string hoTen, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string diaChi, string email, string SDT, string ghiChu, object userState) {
            ...
            this.InvokeAsync("KTThongTinThemKH", new object[] {
                        ...
                        email,
                        SDT,
                        ghiChu}, this.KTThongTinThemKHOperationCompleted, userState);
        }
        ...
        public int KTThongTinSuaKH(System.DateTime ngayMoTK, string hoTenKH, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string soCMNDCu, string diaChi, string email, string sdt, string ghiChu) {
        ...
        /// <remarks/>
        public void KTThongTinSuaKHAsync(System.DateTime ngayMoTK, string hoTenKH, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string soCMNDCu, string diaChi, string email, string sdt, string ghiChu) {
            this.KTThongTinSuaKHAsync(ngayMoTK, hoTenKH, ngaySinh, ngheNghiep, soCMND, soCMNDCu, diaChi, email, sdt, ghiChu, null);
        }
        
        /// <remarks/>
        public void KTThongTinSuaKHAsync(System.DateTime ngayMoTK, string hoTenKH, System.DateTime ngaySinh, string ngheNghiep, string soCMND, string soCMNDCu, string diaChi, string email, string sdt, string ghiChu, object userState) {
            ...
            this.InvokeAsync("KTThongTinSuaKH", new object[] {
                        ...
                        email,
                        sdt,
                        ghiChu}, this.KTThongTinSuaKHOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetKHWithID", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string GetKHWithID(int idKH) {
            object[] results = this.Invoke("GetKHWithID", new object[] {
                        idKH});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void GetKHWithIDAsync(int idKH) {
            this.GetKHWithIDAsync(idKH, null);
        }
        
        /// <remarks/>
        public void GetKHWithIDAsync(int idKH, object userState) {
            if ((this.GetKHWithIDOperationCompleted == null)) {
                this.GetKHWithIDOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetKHWithIDOperationCompleted);
            }
            this.InvokeAsync("GetKHWithID", new object[] {
                        idKH}, this.GetKHWithIDOperationCompleted, userState);
        }
        
        private void OnGetKHWithIDOperationCompleted(object arg) {
            if ((this.GetKHWithIDCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetKHWithIDCompleted(this, new GetKHWithIDCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void GetKHWithIDCompletedEventHandler(object sender, GetKHWithIDCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetKHWithIDCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetKHWithIDCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
